...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Cetak Laporan Surat Masuk</h1>
        ...
        <div class="col-lg-6">
            <div class="card shadow mb-4">
                <div class="card-header">
                    <a href="/admin/surat_masuk" class="btn ml-n3 text-primary font-weight-bold">
                        <i class="fas fa-chevron-left"></i> Kembali ke daftar surat masuk</a>
                </div>
                <div>
                    <div class="card-body">
                        <form action="<?= base_url('admin/lap_surat_masuk'); ?>" method="get">
...
<!-- Pengambilan data berdasarkan filter tanggal dengan datepicker-->
<script>
