                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Tambah Data Surat Keluar</h1>
                                </div>
                                ...
                                <?php endif; ?>
                                <form action="<?=base_url('/admin/save_keluar')?>" method="post" enctype="multipart/form-data">
                                    <?=csrf_field();?>
                                    <div class="form-group">
                                        <label for="alamat">Alamat Penerima</label>
                                        <input type="text" name="alamat" id="input-alamat" class="form-control form-control-user <?= session('errors.alamat') ? 'is-invalid' : '' ?>" value="<?=old('alamat');?>" autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tgl_surat" id="input-tgl_surat" class="form-control form-control-user <?= session('errors.tgl_surat') ? 'is-invalid' : '' ?>" value="<?=old('tgl_surat');?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="no_surat" id="input-no_surat" class="form-control form-control-user <?= session('errors.no_surat') ? 'is-invalid' : '' ?>" value="<?=old('no_surat');?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="perihal" id="input-perihal" class="form-control form-control-user <?= session('errors.perihal') ? 'is-invalid' : '' ?>" value="<?=old('perihal');?>">
